...
\label{rcp:sobasalaatti}
    ...
    \ingredients{%
		...
		sopivasti	    & cashew- tai pekaanipähkinöitä
    }
    ...
    \preparation{%
        ...
        Veden lämmetessä leikkaa kurkku, inkivääri (mikäli et käytä sushi-inkivääriä) ja sipuli.
        Kaikista näistä olisi kiva saada semmoisia puikkosyötäviä suikaleita. Referenssinä toimiköön 
        kuva 2. Laita pilkotut kasvit kulhoon ja lisää mukaan soija, öljy ja etikka. Sekoita nämä 
