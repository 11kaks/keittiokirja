...
\newpage
\subfile{./tex/reseptit/wokwalk}

% Ainekset on reagenssit synteesissä.
\setHeadlines{inghead = Reagenssit,prephead = Synteesiohje}
\newpage
\subfile{./tex/reseptit/kanasynteesi}
% Vaihda takaisin
\setHeadlines{inghead = Ainekset,prephead = Valmistaminen}

\newpage
\subfile{./tex/reseptit/kanaahoisin}

\newpage
\subfile{./tex/reseptit/tofuwhat}
